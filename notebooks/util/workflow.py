...
def augment_calculation(
    ...
    # Pre-process new species and reactions
    gen_mech_ = automech.drop_duplicate_reactions(mech)
    gen_mech_ = automech.reaction_difference(
        mech, gen_mech, reversible=True, stereo=False, drop_species=True
    )
    gen_spc_ = automech.species.difference(mech.species, gen_mech.species, stereo=False)

    # Expand and sort
    ste_mech_, err_mech_ = automech.expand_stereo(
        gen_mech_, enant=False, distinct_ts=False
    )
    ...
    gen_mech.reactions = polars.concat(
        [gen_mech.reactions, gen_mech_.reactions], how="diagonal_relaxed"
    )
    gen_mech.species = polars.concat(
        [gen_mech.species, gen_spc_], how="diagonal_relaxed"
    )
    ste_mech.reactions = polars.concat(
        [ste_mech.reactions, ste_mech_.reactions], how="diagonal_relaxed"
    )
    ste_mech.species = polars.concat(
        [ste_mech.species, ste_spc_], how="diagonal_relaxed"
    )
    ...
    # Display
    print("\nStereoexpansion errors:")
    automech.display_reactions(err_mech_)
